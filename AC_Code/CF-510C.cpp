...
Topological Sort
why?
if pre[j]!=now[j] , that mean pre[j] is higher priority to now[j] 
turn it into graph , that mean there is a directed path from node[pre[j] to node[now[j]]
*/
