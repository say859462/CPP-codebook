...
ll n,m,a,b,c,d,e,f,z,k,t,w,x,y;
   ...
   // freopen("output.txt","w",stdout);  // 寫入 file.out 檔
    ...
    for(int i=0;i<n;i++){
        if(pt[i].first==0 || pt[i].second==0){
            if(pt[i].first==0){
                if(pt[i].second>0){
                    cout<<1<<" "<<pt[i].second<<" "<<'U'<<endl;
                    cout<<2<<endl;
                    cout<<1<<" "<<pt[i].second<<" "<<'D'<<endl;
                }
                else{
                    cout<<1<<" "<<abs(pt[i].second)<<" "<<'D'<<endl;
                    cout<<2<<endl;
                    cout<<1<<" "<<abs(pt[i].second)<<" "<<'U'<<endl;
                }
            }
            else{
                if(pt[i].first>0){
                    cout<<1<<" "<<pt[i].first<<" "<<'R'<<endl;
                    cout<<2<<endl;
                    cout<<1<<" "<<pt[i].first<<" "<<'L'<<endl;
                }
                else{
                    cout<<1<<" "<<abs(pt[i].first)<<" "<<'L'<<endl;
                    cout<<2<<endl;
                    cout<<1<<" "<<abs(pt[i].first)<<" "<<'R'<<endl;
                }
            }
            cout<<3<<endl;
            continue;
        ...
        else if(pt[i].first > 0 && pt[i].second < 0){
            cout<<1<<" "<<pt[i].first<<" "<<'R'<<endl;
            cout<<1<<" "<<abs(pt[i].second)<<" "<<'D'<<endl;
            cout<<2<<endl;
            cout<<1<<" "<<pt[i].first<<" "<<'L'<<endl;
