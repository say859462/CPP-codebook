...
ll cost[3]={0};
bool check(ll x){
    ll need_a=x*sum_B,need_b=x*sum_S,need_c=x*sum_C;
    need_a=need_a-a>=0?need_a-a:0;
    need_b=need_b-b>=0?need_b-b:0;
    need_c=need_c-c>=0?need_c-c:0;
    ll sum=need_a*cost[0]+need_b*cost[1]+need_c*cost[2];
    return n>=sum;
}
int main()
{
